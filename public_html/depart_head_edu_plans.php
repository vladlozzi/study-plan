...
if (!defined("IN_ADMIN")) { echo "<p style=\"text-align: center; color: red; font-weight: bold;\">".
                               "Помилка входу в модуль depart_head_edu_plans.php</p>"; require "footer.php"; exit(); }
...
чИННІ робочі навчальні плани, в яких Ваша кафедра є <span style="font-weight: bold;">випускною</span>:</p>
...
?>
	...
	<div style="top: 33px;	right: 1px;	position: fixed; 
										color: blue; font-size: 150%; font-weight: bold; ">
					<?php echo $query_row['reg_number']; ?></div>
<?php 
			}
...
<?php 
	...
	case "DepartSubject": $TrueAdmin = TRUE; 
		$_POST['deptosel'] = (isset($_POST['deptosel'])) ? $_POST['deptosel'] : $_SESSION['user_description'];
...
НЕЗАБАРОМ БУДЕ ГОТОВЕ! --></p><?php 
	...
	case "StudyWorkAmount": $TrueAdmin = FALSE; $TrueBoss = FALSE;
		$_POST['deptosel'] = (isset($_POST['deptosel'])) ? $_POST['deptosel'] : $_SESSION['user_description'];
		require "study_work_amount.php"; break;
} ?>
